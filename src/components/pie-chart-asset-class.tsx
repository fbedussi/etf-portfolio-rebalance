...
export function ChartPie() {
    ...
    const assetClasses = [...new Set(Object.keys(targetAssetClassAllocation).concat(Object.keys(currentAssetClassAllocation)))]
    ...
    const targetAllocationData = Object.entries(targetAssetClassAllocation).map(([assetClass, target]) => ({
        assetClass,
        target,
        fill: `var(--${colors[assetClass]})`,
    }))

    const currentAllocationData = Object.entries(currentAssetClassAllocation).map(([assetClass, actual]) => ({
        assetClass,
        actual,
        fill: `var(--${colors[assetClass]})`,
    }))
